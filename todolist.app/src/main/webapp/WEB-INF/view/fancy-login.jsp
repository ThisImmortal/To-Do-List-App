			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<form:form action="loginProcess" modelAttribute="login"
						...
						<!-- User name -->
						<form:errors path="email" cssClass="alert alert-danger col-xs-offset-1 col-xs-10"/>
						<form:errors path="password" cssClass="alert alert-danger col-xs-offset-1 col-xs-10"/>
